...
export default function contact() {
  return (
    <>
    <Container bg= '#edf2f7' maxW="full" mt={0} centerContent overflow="hidden" pb={6}>
      <Flex>
        <Box
          bg="#ffff"
          color="white"
